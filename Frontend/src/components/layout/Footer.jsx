        ...
        <footer className="border-t border-border/50 bg-background/50 backdrop-blur-xl mt-auto">
            <div className="container mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
                    <div className="col-span-1 md:col-span-2 lg:col-span-2">
                        <Link to="/" className="flex items-center space-x-2 mb-6 group">
                            ...
                            <span className="text-xl font-bold tracking-tight">StuGig</span>
                        </Link>
                        <p className="text-sm text-muted-foreground max-w-xs leading-relaxed mb-6">
                            The smart freelance marketplace built exclusively for ambitious students. Connect, collaborate, and build your portfolio while earning.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-muted-foreground">
                            <li><Link to="/services" className="hover:text-foreground transition-colors">Explore Services</Link></li>
                            <li><Link to="/jobs" className="hover:text-foreground transition-colors">Browse Jobs</Link></li>
                            <li><Link to="/ai-matchmaker" className="hover:text-foreground transition-colors">AI Matchmaker</Link></li>
                ...
                <div className="mt-16 pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} StuGig Inc. All rights reserved.</p>
